...
def generate_launch_description():
    ...
    # planning_context
    pkg_share = FindPackageShare('manipulator_description').find('manipulator_description')
    urdf_dir = os.path.join(pkg_share, 'urdf')
    xacro_file = os.path.join(urdf_dir, 'manipulator.urdf.xacro')
    ...
    ompl_planning_yaml = load_yaml('manipulator_moveit_config', 'config/ompl_planning.yaml')
    ompl_planning_pipeline_config['move_group'].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    controllers_yaml = load_yaml('manipulator_moveit_config', 'config/controllers.yaml')
    ...
    # RViz
    rviz_config_file = get_package_share_directory('manipulator_moveit_config') + "/launch/run_move_group.rviz"
